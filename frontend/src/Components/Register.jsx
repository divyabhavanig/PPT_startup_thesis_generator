    ...
    <div className=' w-screen h-screen bg-gray-300 flex flex-col justify-center items-center'>
      <div className=' w-fit h-fit bg-gray-400 p-8 rounded-md'>
        ...
        <div className='flex flex-col gap-2 mt-2'>
          <input type='text' placeholder='firstname' className=' p-2 outline-none bg-gray-100 rounded-md w-72'/>
          <input type='text' placeholder='lastname' className=' p-2 outline-none bg-gray-100 rounded-md w-72'/>
          ...
          <input type='password' placeholder='Confirm Password' className=' p-2 outline-none bg-gray-100 rounded-md w-72'/>
        </div>

        <div>
          <button className=' w-72 text-green-400 mt-3 py-1 rounded-md font-semibold'>Register</button>
        </div>
      </div>
    </div>
  )
